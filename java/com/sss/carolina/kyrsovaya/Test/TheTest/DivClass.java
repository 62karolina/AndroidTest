...
/**
 * Created by carolina on 30.05.17.
 */
...
public class DivClass {
    ...
    public static void textViewMessage(TextView textView, Button trueB, Button falseB, Button noAns, final Context context, final TextView textView1,
                                       final EditText editText, final String symbol) {
        Random rand = new Random();

        num1 = rand.nextInt(81);
        ...
        noAns.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (num1 % num2 == 0) {
                    Toast.makeText(context, "Вы ответили не правильно", Toast.LENGTH_SHORT).show();
